...
do
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../Grasp_PR/Testes/INST1/correlated/"$p".corr"$i"/pareto_"$p".corr"$i".out reference.out correlated/"$p".corr"$i"/resultador_GRASP.out
		
		echo "$(cat correlated/"$p".corr"$i"/resultador_Tapas.out)\n\n$(cat correlated/"$p".corr"$i"/resultador_TBT.out)\n\n$(cat correlated/"$p".corr"$i"/resultador_GRASP.out)" >> correlated/"$p".corr"$i"/uni_r.out 

		../../../../../Epsilon/PISA/statistics_c_source/kruskal-wallis correlated/"$p".corr"$i"/uni_r.out ../../../../../Epsilon/PISA/statistics_c_source/kruskalparam.txt correlated/"$p".corr"$i"/kruskalPareado.out > correlated/"$p".corr"$i"/kruskalMulti.out
...
do
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../Grasp_PR/Testes/INST1/anticorrelated/"$p".anticorr"$i"/pareto_"$p".anticorr"$i".out reference.out anticorrelated/"$p".anticorr"$i"/resultador_GRASP.out
		
		echo "$(cat anticorrelated/"$p".anticorr"$i"/resultador_Tapas.out)\n\n$(cat anticorrelated/"$p".anticorr"$i"/resultador_TBT.out)\n\n$(cat anticorrelated/"$p".anticorr"$i"/resultador_GRASP.out)" >> anticorrelated/"$p".anticorr"$i"/uni_r.out 

		../../../../../Epsilon/PISA/statistics_c_source/kruskal-wallis anticorrelated/"$p".anticorr"$i"/uni_r.out ../../../../../Epsilon/PISA/statistics_c_source/kruskalparam.txt anticorrelated/"$p".anticorr"$i"/kruskalPareado.out > anticorrelated/"$p".anticorr"$i"/kruskalMulti.out
...
do
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../Grasp_PR/Testes/INST1/concave/"$p".conc"$i"/pareto_"$p".conc"$i".out reference.out concave/"$p".conc"$i"/resultador_GRASP.out
		
		echo "$(cat concave/"$p".conc"$i"/resultador_Tapas.out)\n\n$(cat concave/"$p".conc"$i"/resultador_TBT.out)\n\n$(cat concave/"$p".conc"$i"/resultador_GRASP.out)" >> concave/"$p".conc"$i"/uni_r.out 

		../../../../../Epsilon/PISA/statistics_c_source/kruskal-wallis concave/"$p".conc"$i"/uni_r.out ../../../../../Epsilon/PISA/statistics_c_source/kruskalparam.txt concave/"$p".conc"$i"/kruskalPareado.out > concave/"$p".conc"$i"/kruskalMulti.out
