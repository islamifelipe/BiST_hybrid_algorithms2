...
do
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../Trans1_2obj_hibrid_VVersion1/Testes/INST1/correlated/"$p".corr"$i"/pareto_"$p".corr"$i".out reference.out correlated/"$p".corr"$i"/resultador_TBTnormal.out
		
		echo "$(cat correlated/"$p".corr"$i"/resultador_TBTiteracoes.out)\n\n$(cat correlated/"$p".corr"$i"/resultador_TBTnormal.out)" >> correlated/"$p".corr"$i"/uni_r.out 
...
do
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../Trans1_2obj_hibrid_VVersion1/Testes/INST1/anticorrelated/"$p".anticorr"$i"/pareto_"$p".anticorr"$i".out reference.out anticorrelated/"$p".anticorr"$i"/resultador_TBTnormal.out
		
		echo "$(cat anticorrelated/"$p".anticorr"$i"/resultador_TBTiteracoes.out)\n\n$(cat anticorrelated/"$p".anticorr"$i"/resultador_TBTnormal.out)" >> anticorrelated/"$p".anticorr"$i"/uni_r.out 
...
do
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../Trans1_2obj_hibrid_VVersion1/Testes/INST1/concave/"$p".conc"$i"/pareto_"$p".conc"$i".out reference.out concave/"$p".conc"$i"/resultador_TBTnormal.out
		
		echo "$(cat concave/"$p".conc"$i"/resultador_TBTiteracoes.out)\n\n$(cat concave/"$p".conc"$i"/resultador_TBTnormal.out)" >> concave/"$p".conc"$i"/uni_r.out 
