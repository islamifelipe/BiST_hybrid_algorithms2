...
do
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../../../../../../Desktop/Grasp_PR/Testes/INST1/correlated/"$p".corr"$i"/pareto_"$p".corr"$i".out reference.out correlated/"$p".corr"$i"/resultadoR_GR.out
		
		echo "$(cat correlated/"$p".corr"$i"/resultadoR_TBT.out)\n\n$(cat correlated/"$p".corr"$i"/resultadoR_GR.out)" >> correlated/"$p".corr"$i"/uni_R.out #primeiro TBT dopois GRPR
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../../../../../../Desktop/Grasp_PR/Testes/INST1/anticorrelated/"$p".anticorr"$i"/pareto_"$p".anticorr"$i".out reference.out anticorrelated/"$p".anticorr"$i"/resultadoR_GR.out
		
		echo "$(cat anticorrelated/"$p".anticorr"$i"/resultadoR_TBT.out)\n\n$(cat anticorrelated/"$p".anticorr"$i"/resultadoR_GR.out)" >> anticorrelated/"$p".anticorr"$i"/uni_R.out #primeiro TBT dopois GRPR
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../../../../../../Desktop/Grasp_PR/Testes/INST1/concave/"$p".conc"$i"/pareto_"$p".conc"$i".out reference.out concave/"$p".conc"$i"/resultadoR_GR.out
		
		echo "$(cat concave/"$p".conc"$i"/resultadoR_TBT.out)\n\n$(cat concave/"$p".conc"$i"/resultadoR_GR.out)" >> concave/"$p".conc"$i"/uni_R.out #primeiro TBT dopois GRPR
