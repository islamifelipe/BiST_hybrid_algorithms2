...
do
	...
	do
		...
		echo "$(cat correlated/"$p".corr"$i"/resultadohyp_TAPAS.out)\n\n$(cat correlated/"$p".corr"$i"/resultadohyp_TBTiteracoes.out)" >> correlated/"$p".corr"$i"/uni_hyp.out 
...
do
	...
	do
		...
		echo "$(cat anticorrelated/"$p".anticorr"$i"/resultadohyp_TAPAS.out)\n\n$(cat anticorrelated/"$p".anticorr"$i"/resultadohyp_TBTiteracoes.out)" >> anticorrelated/"$p".anticorr"$i"/uni_hyp.out 
...
do
	...
	do
		...
		echo "$(cat concave/"$p".conc"$i"/resultadohyp_TAPAS.out)\n\n$(cat concave/"$p".conc"$i"/resultadohyp_TBTiteracoes.out)" >> concave/"$p".conc"$i"/uni_hyp.out 
