...
do
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/hyp_ind ../../../../../Epsilon/PISA/indicators_c_source/hyp_ind_param.txt ../../../Trans1_2obj_hibrid_Version2/Testes/INST1/correlated/"$p".corr"$i"/pareto_"$p".corr"$""i".out reference.out correlated/"$p".corr"$i"/resultadoHypTBT.out
	...
	do
		...
		../../../../../Epsilon/PISA/tools_c_source/filter ../../../../../Epsilon/PISA/tools_c_source/filter_param.txt inputFilter.in reference.out
		../../../../../Epsilon/PISA/indicators_c_source/hyp_ind ../../../../../Epsilon/PISA/indicators_c_source/hyp_ind_param.txt ../../../Trans1_2obj_hibrid_Version2/Testes/INST1/anticorrelated/"$p".anticorr"$i"/pareto_"$p".anticorr"$""i".out reference.out anticorrelated/"$p".anticorr"$i"/resultadoHypTBT.out
		../../../../../Epsilon/PISA/indicators_c_source/hyp_ind ../../../../../Epsilon/PISA/indicators_c_source/hyp_ind_param.txt ../../../T-PL/Testes/"$p"/anticorrelated/"$p".anticorr"$i"/"$p".anticorr"$i".PF.log reference.out anticorrelated/"$p".anticorr"$i"/resultadoHypSilvia.out
		
		echo "$(cat anticorrelated/"$p".anticorr"$i"/resultadoHypTBT.out)\n\n$(cat anticorrelated/"$p".anticorr"$i"/resultadoHypSilvia.out)" >> anticorrelated/"$p".anticorr"$i"/uniHyp.out #primeiro TBT dopois silvia
	...
	do
		...
		../../../../../Epsilon/PISA/tools_c_source/filter ../../../../../Epsilon/PISA/tools_c_source/filter_param.txt inputFilter.in reference.out
		../../../../../Epsilon/PISA/indicators_c_source/hyp_ind ../../../../../Epsilon/PISA/indicators_c_source/hyp_ind_param.txt ../../../Trans1_2obj_hibrid_Version2/Testes/INST1/concave/"$p".conc"$i"/pareto_"$p".conc"$""i".out reference.out concave/"$p".conc"$i"/resultadoHypTBT.out
		../../../../../Epsilon/PISA/indicators_c_source/hyp_ind ../../../../../Epsilon/PISA/indicators_c_source/hyp_ind_param.txt ../../../T-PL/Testes/"$p"/concave/"$p".conc"$i"/"$p".conc"$i".PF.log reference.out concave/"$p".conc"$i"/resultadoHypSilvia.out
		
		echo "$(cat concave/"$p".conc"$i"/resultadoHypTBT.out)\n\n$(cat concave/"$p".conc"$i"/resultadoHypSilvia.out)" >> concave/"$p".conc"$i"/uniHyp.out #primeiro TBT dopois silvia
