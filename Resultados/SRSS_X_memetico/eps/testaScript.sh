...
do
	...
	#	mkdir concave/$p.conc$i
		...
		../../../../../Epsilon/PISA/indicators_c_source/eps_ind ../../../../../Epsilon/PISA/indicators_c_source/eps_ind_param.txt ../../../SteinerRadzik_ScatterSearch_PR/Teste/INST1/correlated/$p.corr$i/$p.PF$i.log reference.out correlated/$p.corr$i/resultadoEpsSRSS.out
		../../../../../Epsilon/PISA/indicators_c_source/eps_ind ../../../../../Epsilon/PISA/indicators_c_source/eps_ind_param.txt ../../../memeticRocha2006/algunsTestesRocha/Teste/INST1/correlated/$p.corr$i/$p.PF$i.log reference.out correlated/$p.corr$i/resultadoEpsMemeticoRocha.out
		
		echo "$(cat correlated/$p.corr$i/resultadoEpsSRSS.out)\n\n$(cat correlated/$p.corr$i/resultadoEpsMemeticoRocha.out)" >> correlated/$p.corr$i/uniEps.out #primeiro SRSS
		...
		../../../../../Epsilon/PISA/tools_c_source/filter ../../../../../Epsilon/PISA/tools_c_source/filter_param.txt inputFilter.in reference.out
		../../../../../Epsilon/PISA/indicators_c_source/eps_ind ../../../../../Epsilon/PISA/indicators_c_source/eps_ind_param.txt ../../../SteinerRadzik_ScatterSearch_PR/Teste/INST1/anticorrelated/$p.anticorr$i/$p.PF$i.log reference.out anticorrelated/$p.anticorr$i/resultadoEpsSRSS.out
		../../../../../Epsilon/PISA/indicators_c_source/eps_ind ../../../../../Epsilon/PISA/indicators_c_source/eps_ind_param.txt ../../../memeticRocha2006/algunsTestesRocha/Teste/INST1/anticorrelated/$p.anticorr$i/$p.PF$i.log reference.out anticorrelated/$p.anticorr$i/resultadoEpsMemeticoRocha.out
		
		echo "$(cat anticorrelated/$p.anticorr$i/resultadoEpsSRSS.out)\n\n$(cat anticorrelated/$p.anticorr$i/resultadoEpsMemeticoRocha.out)" >> anticorrelated/$p.anticorr$i/uniEps.out #primeiro SRSS
		...
		../../../../../Epsilon/PISA/tools_c_source/filter ../../../../../Epsilon/PISA/tools_c_source/filter_param.txt inputFilter.in reference.out
		../../../../../Epsilon/PISA/indicators_c_source/eps_ind ../../../../../Epsilon/PISA/indicators_c_source/eps_ind_param.txt ../../../SteinerRadzik_ScatterSearch_PR/Teste/INST1/concave/$p.conc$i/$p.PF$i.log reference.out concave/$p.conc$i/resultadoEpsSRSS.out
