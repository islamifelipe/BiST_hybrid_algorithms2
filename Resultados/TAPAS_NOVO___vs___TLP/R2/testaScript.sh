...
do
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../T-PL/Testes/"$p"/correlated/"$p".corr"$i"/"$p".corr"$i".PF.log reference.out correlated/"$p".corr"$i"/resultador_TLP.out
		
		echo "$(cat correlated/"$p".corr"$i"/resultador_Tapas.out)\n\n$(cat correlated/"$p".corr"$i"/resultador_TLP.out)" >> correlated/"$p".corr"$i"/uni_r.out #primeiro TAPAS dopois TLP
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../T-PL/Testes/"$p"/anticorrelated/"$p".anticorr"$i"/"$p".anticorr"$i".PF.log reference.out anticorrelated/"$p".anticorr"$i"/resultador_TLP.out
		
		echo "$(cat anticorrelated/"$p".anticorr"$i"/resultador_Tapas.out)\n\n$(cat anticorrelated/"$p".anticorr"$i"/resultador_TLP.out)" >> anticorrelated/"$p".anticorr"$i"/uni_r.out #primeiro TAPAS dopois TLP
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../T-PL/Testes/"$p"/concave/"$p".conc"$i"/"$p".conc"$i".PF.log reference.out concave/"$p".conc"$i"/resultador_TLP.out
		
		echo "$(cat concave/"$p".conc"$i"/resultador_Tapas.out)\n\n$(cat concave/"$p".conc"$i"/resultador_TLP.out)" >> concave/"$p".conc"$i"/uni_r.out #primeiro TAPAS dopois TLP
