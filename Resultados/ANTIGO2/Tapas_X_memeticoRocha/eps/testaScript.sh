...
do
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/eps_ind ../../../../../Epsilon/PISA/indicators_c_source/eps_ind_param.txt ../../../Tapas_rocha/Teste/INST1/concave/$p.conc$i/$p.PF$i.log reference.out concave/$p.conc$i/resultadoEpsTapas.out
		...
		echo "$(cat concave/$p.conc$i/resultadoEpsTapas.out)\n\n$(cat concave/$p.conc$i/resultadoEpsMemeticoRocha.out)" >> concave/$p.conc$i/uniEps.out #primeiro tapas
