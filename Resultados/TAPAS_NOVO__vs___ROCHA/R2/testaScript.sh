...
do
	...
	# 	echo "$(cat anticorrelated/"$p".anticorr"$i"/resultadoR_Tapas.out)\n\n$(cat anticorrelated/"$p".anticorr"$i"/resultadoR_Rocha.out)" >> anticorrelated/"$p".anticorr"$i"/uni_R.out #primeiro TAPAS dopois ROCHA
	...
	# 	echo "$(cat correlated/"$p".corr"$i"/resultadoR_Tapas.out)\n\n$(cat correlated/"$p".corr"$i"/resultadoR_Rocha.out)" >> correlated/"$p".corr"$i"/uni_R.out #primeiro TAPAS dopois ROCHA
