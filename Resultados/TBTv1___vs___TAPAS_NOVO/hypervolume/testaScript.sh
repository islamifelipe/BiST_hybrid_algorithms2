...
do
	...
	do
		...
		echo "$(cat correlated/"$p".corr"$i"/resultadoHyp_TBT.out)\n\n$(cat correlated/"$p".corr"$i"/resultadoHyp_Tapas.out)" >> correlated/"$p".corr"$i"/uni_Hyp.out #primeiro TBT dopois silvia
	...
	do
		...
		echo "$(cat anticorrelated/"$p".anticorr"$i"/resultadoHyp_TBT.out)\n\n$(cat anticorrelated/"$p".anticorr"$i"/resultadoHyp_Tapas.out)" >> anticorrelated/"$p".anticorr"$i"/uni_Hyp.out #primeiro TBT dopois silvia
	...
	do
		...
		echo "$(cat concave/"$p".conc"$i"/resultadoHyp_TBT.out)\n\n$(cat concave/"$p".conc"$i"/resultadoHyp_Tapas.out)" >> concave/"$p".conc"$i"/uni_Hyp.out #primeiro TBT dopois silvia
