...
do
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../memeticRocha2006/algunsTestesRocha/Teste/INST1/correlated/"$p".corr"$i"/"$p".PF"$i".log reference.out correlated/"$p".corr"$i"/resultadoR_Rocha.out
		
		echo "$(cat correlated/"$p".corr"$i"/resultadoR_TBT.out)\n\n$(cat correlated/"$p".corr"$i"/resultadoR_Rocha.out)" >> correlated/"$p".corr"$i"/uni_R.out #primeiro TBT dopois ROCHA
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/r_ind ../../../../../Epsilon/PISA/indicators_c_source/r_ind_param.txt ../../../memeticRocha2006/algunsTestesRocha/Teste/INST1/anticorrelated/"$p".anticorr"$i"/"$p".PF"$i".log reference.out anticorrelated/"$p".anticorr"$i"/resultadoR_Rocha.out
		
		echo "$(cat anticorrelated/"$p".anticorr"$i"/resultadoR_TBT.out)\n\n$(cat anticorrelated/"$p".anticorr"$i"/resultadoR_Rocha.out)" >> anticorrelated/"$p".anticorr"$i"/uni_R.out #primeiro TBT dopois ROCHA
	...
	do
		...
		echo "$(cat concave/"$p".conc"$i"/resultadoR_TBT.out)\n\n$(cat concave/"$p".conc"$i"/resultadoR_Rocha.out)" >> concave/"$p".conc"$i"/uni_R.out #primeiro TBT dopois ROCHA
