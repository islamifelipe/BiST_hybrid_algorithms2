...
do
	...
	do
		...
		../../../../../Epsilon/PISA/indicators_c_source/hyp_ind ../../../../../Epsilon/PISA/indicators_c_source/hyp_ind_param.txt ../../../Trans1_2obj_hibrid_VVersion1/Testes/INST1/correlated/"$p".corr"$i"/pareto_"$p".corr"$i".out reference.out correlated/"$p".corr"$i"/resultadoHypTBT.out
		...
		echo "$(cat correlated/"$p".corr"$i"/resultadoHypTBT.out)\n\n$(cat correlated/"$p".corr"$i"/resultadoHypRocha.out)" >> correlated/"$p".corr"$i"/uniHyp.out #primeiro TBT dopois ROCHA
	...
	do
		...
		../../../../../Epsilon/PISA/tools_c_source/filter ../../../../../Epsilon/PISA/tools_c_source/filter_param.txt inputFilter.in reference.out
		../../../../../Epsilon/PISA/indicators_c_source/hyp_ind ../../../../../Epsilon/PISA/indicators_c_source/hyp_ind_param.txt ../../../Trans1_2obj_hibrid_VVersion1/Testes/INST1/anticorrelated/"$p".anticorr"$i"/pareto_"$p".anticorr"$i".out reference.out anticorrelated/"$p".anticorr"$i"/resultadoHypTBT.out
		...
		echo "$(cat anticorrelated/"$p".anticorr"$i"/resultadoHypTBT.out)\n\n$(cat anticorrelated/"$p".anticorr"$i"/resultadoHypRocha.out)" >> anticorrelated/"$p".anticorr"$i"/uniHyp.out #primeiro TBT dopois ROCHA
	...
	do
		...
		../../../../../Epsilon/PISA/tools_c_source/filter ../../../../../Epsilon/PISA/tools_c_source/filter_param.txt inputFilter.in reference.out
		../../../../../Epsilon/PISA/indicators_c_source/hyp_ind ../../../../../Epsilon/PISA/indicators_c_source/hyp_ind_param.txt ../../../Trans1_2obj_hibrid_VVersion1/Testes/INST1/concave/"$p".conc"$i"/pareto_"$p".conc"$i".out reference.out concave/"$p".conc"$i"/resultadoHypTBT.out
		...
		echo "$(cat concave/"$p".conc"$i"/resultadoHypTBT.out)\n\n$(cat concave/"$p".conc"$i"/resultadoHypRocha.out)" >> concave/"$p".conc"$i"/uniHyp.out #primeiro TBT dopois ROCHA
