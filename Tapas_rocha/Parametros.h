...
#define size_pop 150 // 150 // tamanho da populacao
...
#define max_neighbors 6 // numero maximo de vizinhos
#define max_tabu 15 // 14? 20 // quantidade maxima de iteracoes da busca tabu
#define tabutenure 3 // quantidade de iteracoes em que uma aresta permanece como Tabu
#define maxPR 10 // quantidade maxima de iteracoes do PR
