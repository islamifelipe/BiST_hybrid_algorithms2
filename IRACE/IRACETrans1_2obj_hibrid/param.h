...
//IRACE #define QUANTGERACOES 30  //quantidade de iteracoes do TANSGENETICO (IRACE)
//IRACE #define NUMPLASMIDEOS 15 // QUANTIDADE DE PLASMIDEOS (IRACE)
...
//IRACE #define INI_GER_SET 8 //6 //4 // a cada INI_GER_SET geraçoes consecutivas, PROB_VECTOR é incrementado, as probilidades de cada plasmideo e cada transponsson sao atualizadas indivualmente, e a populaçao é reciclada
//IRACE #define PROB_VECTOR 0.5 // probabilidade de executar os plasmideos (1 - PROB_VECTOR é a probabiliade de executar os transponssons)
//IRACE #define PROB_FACTOR 0.1 // fator que incrementa a probilidade dos plasmideos e decrementa a probabilidade dos transpossons
//PROB_VECTOR + PROB_FACTOR


//IRACE #define MAX_TABU 10 // quantidade maxima de iteracoes da busca tabu
//IRACE #define TABUTENURE 5 // quantidade de iteracoes em que uma aresta permanece como Tabu
//IRACE #define MAX_VIZINHOS 15 // numero maximo de vizinhos
