...
#define NUMEROVERTICES 900 // Varia
...
#define NUMPLASMIDEOS 21 //18 //15 // QUANTIDADE DE PLASMIDEOS (IRACE)
...
#define MAX_TABU 15 //15 // 10 // quantidade maxima de iteracoes da busca tabu
#define TABUTENURE 5 //4 // 5 // quantidade de iteracoes em que uma aresta permanece como Tabu
#define MAX_VIZINHOS 17 // 10 // 15 // numero maximo de vizinhos
